  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-gray-50 dark:bg-zinc-950 p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="lg:col-span-2 animate-on-load min-h-[600px]">
          <AffiliateCommissionChart 
            organizationId={organizationId} 
            refreshTrigger={refreshKey}
          />
        ...
        <div className="lg:col-span-1 flex flex-col gap-6 min-h-[600px]">
          {/* Funil de Classificação de Gênero */}
          <div className="animate-on-load flex-1 min-h-0">
            <GenderClassificationFunnel 
              organizationId={organizationId} 
              refreshTrigger={refreshKey}
              onClassifyClick={() => {
