  ...
  */
  ...
  const handleSaveProduct = async () => {
    ...
    const payload = {
      ...
      tiktokPromoProductValue: tiktokPromoProductValue || undefined,
      tiktokPromoProductType: tiktokPromoProductType || 'fixed',
      tiktokPromoProductUntil: tiktokPromoProductUntil || undefined,
      tiktokPromoNewCustomerValue: tiktokPromoNewCustomerValue || undefined,
      tiktokPromoNewCustomerType: tiktokPromoNewCustomerType || 'fixed',
      tiktokPromoShippingValue: tiktokPromoShippingValue || undefined,
      tiktokPromoShippingType: tiktokPromoShippingType || 'fixed',
